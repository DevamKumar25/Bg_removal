        ...
        <div className="flex items-start flex-wrap gap-4 mt-16 xl:mt-24 justify-center">
          <div className="flex items-start gap-4 bg-white border drop-shadow-md p-7 pb-10 rounded hover:scale-105 transition-all duration-500">
            ...
            <div>
              ...
              <p className="text-sm text-neutral-500 mt-1">
                Select any image from your device <br /> to get started—JPEG,
                PNG, or even WebP.
              </p>
            </div>
          </div>
          <div className="flex items-start gap-4 bg-white border drop-shadow-md p-7 pb-10 rounded hover:scale-105 transition-all duration-500">
            ...
            <div>
              ...
              <p className="text-sm text-neutral-500 mt-1">
                Our AI instantly detects and removes the <br /> background with
          ...
          <div className="flex items-start gap-4 bg-white border drop-shadow-md p-7 pb-10 rounded hover:scale-105 transition-all duration-500">
            ...
            <div>
              ...
              <p className="text-sm text-neutral-500 mt-1">
                Download your new image in high quality<br />
